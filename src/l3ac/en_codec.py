...
import l3ac.codec as base_codec
...
class EnCodec(base_codec.Codec):
    def __init__(self, mc: ModelConfig):
        ...
        if mc.en_coder_compress_rate == 1 and mc.en_coder_cache_size == 0:
            ...
            self.en_encoder = LocalEncoder(feature_dim=mc.feature_dim, depth=1,
            ...
            self.en_encoder = CompressedLocalEncoderWithCache(feature_dim=mc.feature_dim, depth=3,
                                                              local_window_size=mc.en_coder_window_size,

...
class V3FirstBlock(base.BaseBlock):  # (1, 5, 11, 21, 45)
    def __init__(
        ...
        super().__init__(h_dim, conv_kernels, pool_kernels, dilation_rate=dilation_rate, causal=causal)
...
def FirstBlock(dim, causal: bool = False):
    return V3FirstBlock(
        dim,
        conv_kernels=(7, 7, 7, 7, 7),
        pool_kernels=(1, 5, 11, 21, 45),
...
class EnhanceBlock(base.BaseBlock):
    def __init__(self, dim, causal: bool = False):
        super().__init__(4, conv_kernels=(7, 7, 7, 7), pool_kernels=(1, 3, 5, 9), causal=causal)
        self.dim = dim
